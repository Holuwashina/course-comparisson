...
import DialogComponenent from "./DialogComponenent";
...
export default function Header({ courses }) {
  ...
  return (
    <>
      <DialogComponenent filteredData={filteredData} open={open} handleOpen={handleOpen} />

      <Navbar className="mx-auto px-4 py-2 lg:px-8 lg:py-4 shadow-none border-b border-blue-gray-50 rounded-none border-l-0 border-r-0">
        <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
          ...
          <div className="hidden items-center gap-x-2 lg:flex">
            ...
            <Button
              ...
              size="md"
              className="rounded-lg bg-red-900 text-xs"
            >
              Search
            </Button>
          </div>
